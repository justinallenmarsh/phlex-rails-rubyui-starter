module Views
  module Home
    class Index < Views::Base
      ...
      def view_template
        Layouts.Root do
          div(class: "flex flex-col min-h-screen items-center lg:p-8") do
            ...
            div(class: "flex-1 flex items-center justify-center opacity-100 transition-opacity duration-750 starting:opacity-0") do
